                  ...
                  <div class="row justify-content-center mb-3">
                    <div class="col-md-12 col-xl-10">
                              ...
                              <div class="d-flex flex-column mt-4">
                                ...
                                <div class="my-3">
                                   <span class="text-primary"> Started {{$product->created_at}} </span> <br>
                                    <span class="text-danger">End: after two days from above date</span>  <br>
                                </div>
                              </div>
                            </div>
                          </div>
                     ...
                     {{-- end --}}
                           ...
                           @else
                           <h4 class="text-center"> There is no user paid for this project ! </h4>
                         @endif
                          {{-- User Bid --}}
                    </div>
                  </div>
